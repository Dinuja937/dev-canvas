  ...
  return (
    <div className="flex-1 w-full bg-white">
      <div className="max-w-5xl mx-auto px-6 sm:px-10 py-10 flex flex-col gap-10">
        ...
        {/* ── Profile hero ─────────────────────────────────────── */}
        <div
          className="relative rounded-2xl border border-slate-100 bg-white p-8 flex flex-col sm:flex-row items-start sm:items-center gap-6 overflow-hidden"
        ...
        {/* ── Stats bar ────────────────────────────────────────── */}
        <div
          className="flex items-center justify-around py-5 rounded-2xl border border-slate-100 bg-slate-50/50"
        ...
        <div className="flex flex-col gap-6" style={{ animation: 'fadeUp 0.5s ease 0.2s both' }}>
          ...
          {projects.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 px-6 border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50/30">
