...
const HeartIcon = ({ filled }) => (
  <svg className="w-[18px] h-[18px] transition-transform duration-150 group-active:scale-75" viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={filled ? 0 : 2}>
